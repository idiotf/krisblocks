const LibraryCreator = {
    start: (blocksJSON, category, text) => {
      ...
      if (typeof useWebGL == "undefined") {
        ...
        // 아이콘 적용
        $('head').append(`<style>#entryCategory${category}{background-image:url(https://raw.githubusercontent.com/pkselpl2/krisblocks/refs/heads/main/krislogo.svg.svg);background-repeat:no-repeat;margin-bottom:1px;background-position-y: 10px;background-size: 20px;}.entrySelectedCategory#entryCategory${category}{background-image:url(https://raw.githubusercontent.com/pkselpl2/krisblocks/refs/heads/main/krislogo.svg.svg);background-color:#000000;border-color:#000000;color:#fff}</style>`)
        // 카테고리 이름 적용
...
'kris_project_start',
'kris_project_stop',
'kris_iframe_allow_click',
'kris_iframe_block_click',
'kris_iframe_opacity',
'kris_iframe_hide',
'kris_iframe_show',
...
<style>
#entryCategoryAPI {
background-image: url(https://raw.githubusercontent.com/pkselpl2/krisblocks/ef37224a6ad7032098f43d0350e0a5d4f2dea9fe/krislogo.svg.svg);
...
$('#entryCategoryAPI').append('크리스'), alert("현재크리스블럭은0.1입니다~(알림)"),console.log("크리스블럭 작동이 시작되었습니다."),document.title = "K_Block_entry";
